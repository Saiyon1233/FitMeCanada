...
// ----------------------------------------------------------------
var url = 'https://www.roots.com/ca/en/womens-natural-2-strap-46030459.html?selectedColor=CI7&cgid=WomensFootwear&start=1&itemsourse=productlist'
...
// ----------------------------------------------------------------
var chestBust = 110;
var waistCircumference = 90;
var hipCircumference = 115;
var hatCircumference = 60;
var shoeSize = 11;
...
if (url.toUpperCase().includes('WWW.ROOTS.COM/CA')){ // Roots Compatibility and Data Processing
    ...
    var roots_hat = (url.toUpperCase().includes(hat)) ? true:false;
    var roots_shoe = (
